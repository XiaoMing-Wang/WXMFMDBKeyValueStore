 ...
 */
@interface NSDictionary (WXMFMDBModel)
...
/**
 ...
 There's no need to add '<WXMFMDBModel>' to your class header.
 */
...
/**
 ...
 Example:
    ...
    model:
        @interface WXMFMDBBook : NSObject
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
        @class WXMFMDBShadow, WXMFMDBBorder, WXMFMDBAttachment;
 
        @interface WXMFMDBAttributes
        @property NSString *name;
        ...
        @implementation WXMFMDBAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [WXMFMDBShadow class],
                     @"borders" : WXMFMDBBorder.class,
                     @"attachments" : @"WXMFMDBAttachment" };
        }
        @end
...
/**
 ...
 Example:
        @class WXMFMDBCircle, WXMFMDBRectangle, WXMFMDBLine;
 
        @implementation WXMFMDBShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [WXMFMDBCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [WXMFMDBRectangle class];
            } else if (dictionary[@"y2"] != nil) {
                return [WXMFMDBLine class];
            } else {
                return [self class];
            }
        }
